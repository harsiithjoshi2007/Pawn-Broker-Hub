...
export default function NewCustomer() {
  ...
  const onSubmit = async (data: CustomerFormValues) => {
    try {
      ...
      // but the generated client should handle it
      const payload = {
        ...data,
      ...
      const result = await createCustomer.mutateAsync({ data: payload });
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
          ...
          <div className="flex justify-end gap-4">
            ...
            <Button type="submit" className="bg-sidebar-primary hover:bg-sidebar-primary/90 text-primary-foreground min-w-[150px]" disabled={createCustomer.isPending}>
