  ...
  try {
    ...
    const [customer] = await db
      ...
      .values({
        ...
        relativeName: req.body.relativeName || null,
  ...
  try {
    ...
    const [updated] = await db
      ...
      .set({
        ...
        ...(req.body.relationType !== undefined && { relationType: nullify(req.body.relationType) }),
        ...(req.body.relativeName !== undefined && { relativeName: nullify(req.body.relativeName) }),
